...
<div id="signupbox" style="display:; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            ...
                            <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="login(2).php" onclick="">Sign In</a></div>
                        </div>  
                        <div class="panel-body" >
                            <form id="signupform" method="post" class="form-horizontal" role="form">
								...
								<div class="form-group">
                                    <label for="password_again" class="col-md-3 control-label">Password_Again</label>
                                    <div class="col-md-9">
